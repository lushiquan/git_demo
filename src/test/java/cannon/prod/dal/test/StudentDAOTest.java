...
public class StudentDAOTest {
	...
	public void init() {
		try {
			...
			this.context = new ClassPathXmlApplicationContext("META-INF/spring/spring-dal-context.xml");
	...
	public void testInsert() throws Exception {
		int result = studentDAO.deleteByNo("0002");
	...
	public void getByTable() {
		...
		sc.setDatabaseSuffix("_00");
		sc.setTableSuffix("_00");
